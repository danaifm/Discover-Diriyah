...
public class EventsDescriptionImageItem : MonoBehaviour
{
    ...
    {
        EventsDescriptionImagesManager.Instance.OnSpecificItemSelection(ItemIndex);
    }
    public void OnSelect()
    {
        SelectionImage.SetActive(true);
        EventsDescriptionImagesManager.Instance.ChangeDescriptionImage(ImageItem.sprite);
    }
    ...
    IEnumerator GetThumbnail(string uri)
    {
        ...
        else
        {
            ...
            if (ItemIndex == 0)
            {
                EventsDescriptionImagesManager.Instance.DescriptionImage.sprite = ImageItem.sprite;
            }
        }
    }
}
