...
public class AccommodationDescriptionImageItem : MonoBehaviour
{
    ...
    {
        AccommodationDescriptionImagesManager.Instance.OnSpecificItemSelection(ItemIndex);
    }
    public void OnSelect()
    {
        SelectionImage.SetActive(true);
        AccommodationDescriptionImagesManager.Instance.ChangeDescriptionImage(ImageItem.sprite);
    }
    ...
    public void LoadLocalFile()
    {
        ...
        ImageItem.sprite = thumbnail;
    }
    public void ResetImage()
    {
        ImageItem.sprite = DefaultSprite;
    }
    ...
    IEnumerator GetThumbnail(string uri)
    {
        ...
        else
        {
            ...
            if (ItemIndex == 0)
            {
                AccommodationDescriptionImagesManager.Instance.DescriptionImage.sprite = ImageItem.sprite;
            }
        }
    }
}
