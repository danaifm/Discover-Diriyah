...
public class RestaurantDescriptionImageItem : MonoBehaviour
{
    ...
    {
        RestaurantDescriptionImagesManager.Instance.OnSpecificItemSelection(ItemIndex);
    }
    public void OnSelect()
    {
        SelectionImage.SetActive(true);
        RestaurantDescriptionImagesManager.Instance.ChangeDescriptionImage(ImageItem.sprite);
    }
    ...
    IEnumerator GetThumbnail(string uri)
    {
        ...
        else
        {
            ...
            if (ItemIndex == 0)
            {
                RestaurantDescriptionImagesManager.Instance.DescriptionImage.sprite = ImageItem.sprite;
            }
        }
    }
}
